...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../figures/04_satellite_galaxies_gaussian_mc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../figures/04_satellite_galaxies_poissonian_mc.png}
