...
def main():
    ...
    runtime_scalar = timeit.timeit("polygon_area(x_vertices, y_vertices)", setup=setup, globals=globals(), number=N)
    runtime_vector = timeit.timeit("polygon_area_vector(x_vertices, y_vertices)", setup=setup, globals=globals(), number=N)
